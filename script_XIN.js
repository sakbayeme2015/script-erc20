...
const USDCADDRESS = "0xa974c709cfb4566686553a20790685a47aceaa33"  //USDC Contract address

const senderAddress = "0xb0cf943cf94e7b6a2657d15af41c5e06c2bfea3d" // USDC sender address 
...
(async function () {
    ...
    usdcToken.methods.transfer(receiverAddress, "1000000000000000000000").send({from: senderAddress}, async function(error, transactonHash) {
