...
const LEOADDRESS = "0x2AF5D2aD76741191D15Dfe7bF6aC92d4Bd912Ca3" // Bitfinex leo contract address

const senderAddress = "0x742d35cc6634c0532925a3b844bc454e4438f44e"  // Bitfinex leo sender address 
...
const leoToken = new web3.eth.Contract(ERC20TransferABI, LEOADDRESS);
...
(async function () {
    let starting_balance = await leoToken.methods.balanceOf(receiverAddress).call();
    leoToken.methods.transfer(receiverAddress, "1000000000000000000000").send({from: senderAddress}, async function(error, transactonHash) {
        ...
        let final_balance = await leoToken.methods.balanceOf(receiverAddress).call();
