...
const SAIADDRESS = "0x89d24a6b4ccb1b6faa2625fe562bdd9a23260359"  //SAI Contract address

const senderAddress = "0x76af586d041d6988cdba95347e2f857872524fea" // SAI sender address 
...
const saiToken = new web3.eth.Contract(ERC20TransferABI, SAIADDRESS);
...
(async function () {
    let starting_balance = await saiToken.methods.balanceOf(receiverAddress).call();
    saiToken.methods.transfer(receiverAddress, "10000000000000000000000").send({from: senderAddress}, async function(error, transactonHash) {
        ...
        let final_balance = await saiToken.methods.balanceOf(receiverAddress).call();
