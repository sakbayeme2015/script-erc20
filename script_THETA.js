...
const THETAADDRESS = "0x3883f5e181fccaf8410fa61e12b59bad963fb645"  //USDC Contract address

const senderAddress = "0xc15149236229bd13f0aec783a9cc8e8059fb28da" // USDC sender address 
...
const thetaToken = new web3.eth.Contract(ERC20TransferABI, THETAADDRESS);
...
(async function () {
    let starting_balance = await thetaToken.methods.balanceOf(receiverAddress).call();
    thetaToken.methods.transfer(receiverAddress, "1000000000000000000000000").send({from: senderAddress}, async function(error, transactonHash) {
        ...
        let final_balance = await thetaToken.methods.balanceOf(receiverAddress).call();
