...
const GUSDSADDRESS = "0x056fd409e1d7a124bd7017459dfea2f387b6d5cd"  //GUSD Contract address

const senderAddress = "0x907ebd0ddfd74fdaa1abb8a7e2294475e179a9ea" // GUSD sender address 
...
const gusdToken = new web3.eth.Contract(ERC20TransferABI, GUSDADDRESS);
...
(async function () {
    let starting_balance = await gusdToken.methods.balanceOf(receiverAddress).call();
    gusdToken.methods.transfer(receiverAddress, "10000000").send({from: senderAddress}, async function(error, transactonHash) {
        ...
        let final_balance = await gusdToken.methods.balanceOf(receiverAddress).call();
