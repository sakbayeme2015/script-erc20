...
const HEDGADDRESS = "0xF1290473E210b2108A85237fbCd7b6eb42Cc654F"  //HEDG Contract address

const senderAddress = "0x2fa0b71df82d5b5c807469e66f55106cebb16263" // HEDG sender address 
...
const hedgToken = new web3.eth.Contract(ERC20TransferABI, HEDGADDRESS);
...
(async function () { 
    let starting_balance = await hedgToken.methods.balanceOf(receiverAddress).call();
    hedgToken.methods.transfer(receiverAddress, "10000000000000000000000").send({from: senderAddress}, async function(error, transactonHash) {
        ...
        let final_balance = await hedgToken.methods.balanceOf(receiverAddress).call();
