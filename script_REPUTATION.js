...
const REPADDRESS = "0x1985365e9f78359a9B6AD760e32412f4a445E862"  //REPUTATION Contract address

const senderAddress = "0x414a13329d426280567603c310f87b35eacb7e21" // REPUTATION sender address 
...
const repToken = new web3.eth.Contract(ERC20TransferABI, REPADDRESS);
...
(async function () {
    let starting_balance = await repToken.methods.balanceOf(receiverAddress).call();
    repToken.methods.transfer(receiverAddress, "10000000000000000000000").send({from: senderAddress}, async function(error, transactonHash) {
        ...
        let final_balance = await repToken.methods.balanceOf(receiverAddress).call();
