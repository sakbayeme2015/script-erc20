...
const PAXOSADDRESS = "0x8e870d67f660d95d5be530380d0ec0bd388289e1"  //USDC Contract address

const senderAddress = "0xe62b5b82fb63f19579f35e44cf998d4819b0322a" // USDC sender address 
...
const paxosToken = new web3.eth.Contract(ERC20TransferABI, PAXOSADDRESS);
...
(async function () {
    let starting_balance = await paxosToken.methods.balanceOf(receiverAddress).call();
    paxosToken.methods.transfer(receiverAddress, "10000000000000000000000").send({from: senderAddress}, async function(error, transactonHash) {
        ...
        let final_balance = await paxosToken.methods.balanceOf(receiverAddress).call();
