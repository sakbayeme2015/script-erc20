...
const BNUSDADDRESS = "0x4Fabb145d64652a948d72533023f6E7A623C7C53"  //BNUSD Contract address

const senderAddress = "0xf977814e90da44bfa03b6295a0616a897441acec" // BNUSD sender address 
...
const bnusdToken = new web3.eth.Contract(ERC20TransferABI, BNUSDADDRESS);
...
(async function () {
    let starting_balance = await bnusdToken.methods.balanceOf(receiverAddress).call();
    bnusdToken.methods.transfer(receiverAddress, "10000000000000000000000").send({from: senderAddress}, async function(error, transactonHash) {
        ...
        let final_balance = await bnusdToken.methods.balanceOf(receiverAddress).call();
